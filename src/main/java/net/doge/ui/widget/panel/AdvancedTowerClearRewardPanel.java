...
public class AdvancedTowerClearRewardPanel extends GPanel {
    private TowerUI ui;
    ...
    public AdvancedTowerClearRewardPanel(TowerUI ui) {
        this.ui = ui;
        init();
    }

    private void init() {
        for (Reward reward : ActivityData.advancedTowerClearRewards) {
            listModel.addElement(reward);
        }
        titleLabel.setText("积累三塔通关次数，送走塔步数！");
