...
public class TrickData {
    ...
    public static final Trick REGULAR_BOX_DISORDER_222_33_15_WS = new Trick(TrickType.DISORDER_222_33_15_WF, ItemData.REGULAR_BOX, 6, ItemData.MAGIC_BOX, 18);
    ...
    public static final Trick DELUXE_BOX_SAME3 = new Trick(TrickType.SAME3, ItemData.DELUXE_BOX, 3, ItemData.ADVANCED_STEP, 26);
    ...
    public static final Trick DELUXE_BOX_SUB_111 = new Trick(TrickType.SUB_111, ItemData.DELUXE_BOX, 10, ItemData.MAGIC_BOX, 12);
    ...
    private static void initData() {
        ...
        trickSampler.addModel(new SampleModel<>(REGULAR_BOX_DISORDER_222_33_15_WS, 40));
        ...
        trickSampler.addModel(new SampleModel<>(REGULAR_BOX_SAME6, 150));
